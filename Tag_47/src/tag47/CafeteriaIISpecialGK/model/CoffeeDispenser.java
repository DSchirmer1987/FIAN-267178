...
public class CoffeeDispenser extends Thread implements IDrinkingCoffee {
	...
	public String toString() {
		return "CoffeeDispenser [pause=" + pause + ", lock=" + lock + ", pauseLength=" + pauseLength + ", nameCD="
				+ nameCD + ", getNameKA()=" + getNameKA() + ", getNameCD()=" + getNameCD() + ", isPause()=" + isPause()
				+ ", getLock()=" + getLock() + ", getPauseLength()=" + getPauseLength() + "]";
	}
